...
<h3 style="font-family:Comic Sans MS; color: white; position: relative; left:190px;"><?php echo "Welcome ". $_SESSION['username']?>! You can Play Music to Play</h3>
<hr>
<div class="gif image">
            <img src="song description/songs/images/girl0.gif" style="position: fixed; left: 390px; top: 50px;" >
